...
public:
  string zero = "\nDividing by zero is like cutting the cake into 0 pieces, "
                "which doesn't make any sense at all if you think of it, as "
                "the cake itself is already made of a single piece\n\n";
